...
#>
	...
	`$Assembly.GetType("ZipStuff.ZipStuff").GetMethod("InvokeZipStuff").Invoke(`$Null, @(,`$passed))
"@

	Get-Content "..\..\Template.ps1" | %{$_ -replace "#ENCODEDCONTENTHERE", $Output} | Write-Output
}
